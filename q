...
[policy]
url-latency-benchmark=优选节点, resource-tag-regex=机场合集, server-tag-regex=^(?!.*网易云), check-interval=300, tolerance=80, alive-checking=false, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/Urltest.png
static=自选节点, 优选节点, proxy, 香港, 台湾, 日本, 新加坡, 美国, 加拿大, 英国, 其他, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/Static.png
...
url-latency-benchmark=香港, resource-tag-regex=机场合集, server-tag-regex=(?=.*(港|HK|(?i)Hong))^((?!(台|日|韩|新|美|直连)).)*$, check-interval=3600, tolerance=80, alive-checking=false, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/HK.png
...
url-latency-benchmark=日本, resource-tag-regex=机场合集, server-tag-regex=(?=.*(日|JP|(?i)Japan))^((?!(港|台|韩|新|美|直连)).)*$, check-interval=3600, tolerance=80, alive-checking=false, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/JP.png
...
url-latency-benchmark=其他, server-tag-regex=菲律宾|荷兰|印度|德国|泰国, check-interval=3600, tolerance=0, alive-checking=false, img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Area.png
...
#服务器远程订阅
[server_remote]
https://sub.store/download/%F0%9F%90%A7, tag=企鹅, img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Panda.png, update-interval=172800, opt-parser=false, enabled=true
https://sub.store/download/%E4%BA%91%E4%B8%8Agirsun.org, tag=云上, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Alpha/WestData.png, update-interval=172800, opt-parser=false, enabled=false
...
https://sub.store/download/%E7%99%BD%E5%AB%96%E6%9C%BA%E5%9C%BA, tag=白嫖, update-interval=172800, opt-parser=false, enabled=true
https://sub.store/download/collection/%E6%9C%BA%E5%9C%BA%E5%90%88%E9%9B%86, tag=机场合集, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Alpha/Touhou.png, update-interval=21600, opt-parser=false, enabled=true
...
#规则分流远程订阅
[filter_remote]
https://raw.githubusercontent.com/28413761/QX/main/fenliuxiuzheng.list, tag=分流修正, force-policy=direct, update-interval=172800, opt-parser=false, enabled=true
...
https://raw.githubusercontent.com/limbopro/Profiles4limbo/main/airports.list, tag=机场专线, force-policy=自选节点, update-interval=172800, opt-parser=false, enabled=true
...
https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rewrite/QuantumultX/Advertising/Advertising.conf, tag=b7去广告, update-interval=172800, opt-parser=false, enabled=false
...
[filter_local]
host, bpjc.xyz, 自选节点
host, girsun.org, 自选节点
host, xn--4gq62f52gdss.com, 自选节点
host, ek12.work, 自选节点
